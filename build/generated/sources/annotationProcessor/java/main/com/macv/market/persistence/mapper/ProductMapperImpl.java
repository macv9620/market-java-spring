...
public class ProductMapperImpl implements ProductMapper {
    ...
    public Product toProduct(Producto producto) {
        ...
        if ( producto.getIdProducto() != null ) {
            product.setId( producto.getIdProducto() );
        }
        ...
        product.setBarCode( producto.getCodigoBarras() );
    ...
    public Producto toProducto(Product product) {
        ...
        producto.setIdProducto( product.getId() );
        ...
        producto.setCodigoBarras( product.getBarCode() );
